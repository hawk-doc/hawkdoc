...
### Added
- Test suites: Vitest in both workspaces — API integration tests against PostgreSQL (trash lifecycle, access control, validation) and jsdom tests for the offline document store, title sync and session expiry. Both run in CI
